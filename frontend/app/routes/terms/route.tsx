            ...
            <div className={styles.termsContainer}>
                ...
                <div className={styles.termsContent}>
                    ...
                    <TermsSection title="6. Limitación de responsabilidad e indemnización">
                        ...
                        <p className="pt-4">En caso de que un Usuario sea encontrado responsable o culpable de haber incurrido en una conducta fraudulenta o ilícita, ya sea como resultado de una investigación interna o por resolución de autoridad competente, Atlana podrá tomar medidas correctivas, incluyendo la suspensión definitiva de la cuenta y, de ser necesario, la entrega de información a las autoridades. Asimismo, Atlana podrá colaborar activamente con la víctima para facilitar la resolución del conflicto.</p>
